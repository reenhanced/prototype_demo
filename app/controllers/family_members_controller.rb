class FamilyMembersController < ApplicationController
  ...
  def create
    ...
    if @family_member.save
      flash[:notice] = "Successfully added family_member."
    else
      flash[:error] = "We were unable to save the family_member.  Please check the information you entered and try again."
    end
  ...
  def destroy
    ...
    redirect_to @family_card, :notice => "Successfully removed the family_member."
  end
